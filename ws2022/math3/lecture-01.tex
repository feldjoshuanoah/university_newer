...
\begin{proposition}[Linearität des Lebesgue-Integrales]
...
\begin{proposition}[Lebesgues Satz von der monotonen Konvergenz]\label{proposition:16}
...
\begin{lemma}[Fatous Lemma]\label{lemma:17}
